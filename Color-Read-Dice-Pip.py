...
def hough_circles(source):  # referenced lecture slides 09 87p
    ...
    circles = cv2.HoughCircles(source, cv2.HOUGH_GRADIENT, 1, 5, param1=160, param2=21, maxRadius=20)
...
def count_circles(binary_source, src):  # referenced lecture slides 12 21p
    ...
    for i in range(1, cnt):
        ...
        if area < 2000 or area>10000:   # 노이즈 무시하기 위해 사용
            continue
...
dst = cv2.adaptiveThreshold(src, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY, 13, 1)
